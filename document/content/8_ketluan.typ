...
Qua luận văn này, tôi đã nghiên cứu và hiểu hơn về lĩnh vực luật và các công cụ AI mới nhất hiện nay. Và thấy được tính khả thi khi áp dụng các công cụ AI này vào luật. Vì thiếu điều kiện, kinh phí để có thể thí nghiệm thêm, tôi chỉ có thể đưa ra một số ý tưởng và đề xuất cho các nghiên cứu sau này. Gồm 3 ý chính:

- *Xây dựng các bộ dữ liệu liên quan tới luật* như đã làm trong @phan3, tuy nhiên bộ dữ liệu mà tôi đã xây dựng chỉ mới là một phần nhỏ trong tất cả văn bản (chỉ bao gồm các văn bản liên quan tới bảo hiểm xã hội).  Và còn thiếu liên kết giữa các điều luật với nhau, ví dụ: Điều 28 luật hôn nhân 2014 *_được hướng dẫn_* bởi điều Điều 7 Nghị định 126/2014/NĐ-CP. Cần có một bộ dữ liệu đầy đủ hơn, bao gồm nhiều lĩnh vực pháp luật khác nhau, để có thể đưa ra được những kết quả chính xác nhất.
